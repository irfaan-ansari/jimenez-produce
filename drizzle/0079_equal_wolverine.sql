...
--> statement-breakpoint
ALTER TABLE "product" ADD COLUMN "is_taxable" boolean DEFAULT true;--> statement-breakpoint
...
CREATE INDEX "tax_rule_item_teamId_idx" ON "tax_rule_item" USING btree ("team_id");--> statement-breakpoint
ALTER TABLE "price_level" ADD CONSTRAINT "price_level_organization_id_organization_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organization"("id") ON DELETE cascade ON UPDATE no action;