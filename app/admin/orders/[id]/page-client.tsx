...
import { useOrder } from "@/features/admin/data/order";
    ...
    >
      <div className="col-span-6 space-y-6 lg:col-span-4">
        ...
        <Card className="rounded-2xl">
          <CardContent className="flex flex-col items-start justify-between gap-4 text-base md:flex-row">
            {STEPS.map((step, i) => (
              <StepItem key={i} {...step} />
            ))}
          </CardContent>
...
const StepItem = ({
  ...
  <div className="flex items-start self-start gap-3 md:flex-col md:items-center">
    <span
