              ...
              organizations.map((org) => {
                ...
                return (
                  <TableRow key={org.id}>
                    <TableCell className="p-4">
                      ...
                      >
                        <Avatar className="size-9 relative rounded-lg ring-2 ring-green-600/40 ring-offset-1 **:rounded-lg after:hidden">
                          ...
                          <span className="absolute bg-green-500 border-2 opacity-0 size-3 group-data-active:opacity-100 -bottom-1 -right-1"></span>
                        </Avatar>
                    ...
                    <TableCell className="p-4 font-medium w-28 text-muted-foreground">
