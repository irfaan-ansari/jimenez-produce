    ...
    return (
      ...
      >
        <DrawerContent
          ...
          className={cn("max-h-[90vh] gap-2", className)}
          {...props}
        >
          {activeSubmenu ? (
            <>
              ...
              <div className="relative max-h-[70vh] flex-1 overflow-y-auto">
                ...
                >
                  <motion.div
                    ...
                    className="h-full w-full space-y-0.5 pb-6"
                  >
                    {activeSubmenu
              ...
              <div className="max-h-[70vh] overflow-y-auto">
                ...
                >
                  <motion.div
                    ...
                    exit="exit"
                    transition={transition}
                    className="w-full space-y-0.5 pb-6"
                  >
                    {children}
                  </motion.div>
                </AnimatePresence>
  ...
  if (isMobile) {
    ...
    const content = (
      <div
        ...
        className={cn(
          "flex cursor-pointer items-center justify-between px-4 h-11 py-3",
          // Only apply margin, background and rounded corners if not in a group
          !isInsideGroup && "bg-secondary/60 dark:bg-accent mx-2 rounded-md",
          // For items in a group, don't add background but add more padding
          isInsideGroup && "bg-transparent py-3 h-11",
          inset && "pl-8",
