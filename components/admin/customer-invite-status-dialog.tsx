...
type StatusVariant = "rejected" | "revoked";

export const CustomerInviteStatusDialog = ({
  id,
  showDialog,
  setShowDialog,
  variant,
                ...
                children={(field) => {
                  ...
                  return (
                    <Field>
                      ...
                      />
                      <FieldDescription>
                        Explain why the access was revoked or rejected
                      </FieldDescription>
                      {isInvalid && (
                ...
                children={(field) => {
                  ...
                  return (
                    <Field>
                      ...
                      />
                      <FieldDescription>
                        Optional notes for internal use only.
                      </FieldDescription>
                      {isInvalid && (
                        <FieldError errors={field.state.meta.errors} />
                      )}
