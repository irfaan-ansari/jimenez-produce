...
export const CatalogTemplate = ({ name, pdfUrl, digitalUrl }: Props) => {
  return (
    <EmailTemplate template="customer" heading="Weekly Price List">
      <Section className="p-6">
        ...
        <Section className="my-8 text-left flex">
          ...
          <Button
            href={`https://wa.me/12512622607`}
            className="rounded-xl bg-[#075E54] align-middle leading-none text-base inline-flex items-center px-10 py-4 text-white font-medium no-underline"
          >
            <svg
              role="img"
