  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            "flex h-11 items-center justify-between rounded-xl border border-input px-3 py-2 text-base ring-offset-background focus-within:ring-1 focus-within:ring-ring  md:text-sm",
            {
        ...
        >
          <div className="relative flex flex-1 flex-wrap gap-1">
            <CommandPrimitive.Input
              ...
              className={cn(
                "w-full flex-1 self-baseline bg-transparent outline-none placeholder:text-muted-foreground",
                {
